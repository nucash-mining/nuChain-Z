...
# Consumer GPUs (ASIC Resistant)
NVIDIA_RTX_3080_ENABLED=true
NVIDIA_RTX_3090_ENABLED=true
NVIDIA_RTX_4080_ENABLED=true
NVIDIA_RTX_4090_ENABLED=true
AMD_RX_6800_XT_ENABLED=true
AMD_RX_6900_XT_ENABLED=true
AMD_RX_7800_XT_ENABLED=true
AMD_RX_7900_XTX_ENABLED=true
...
EQUIHASH_MINING=true
EQUIHASH_N=144
EQUIHASH_K=5
MEMORY_REQUIREMENT_GB=1
ASIC_RESISTANCE_CHECK=true
